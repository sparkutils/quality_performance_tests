...
object TestSourceData extends TestUtils {
  ...
  val MAXSIZE = 500000 // 10000000  10mil, takes about 1.5 - 2hrs on dev box , 2m only on server is 3hours or so without dmn it's over 6hrs with, doing a single 1m run
  val STEP =    500000
